<template>
  ...
  >
    <div class="max-w-4xl mx-auto text-center">
      <!-- Logo -->
      <div class="text-2xl font-bold mb-8">{{ companyName }}</div>
      ...
      <div class="mb-8">
        ...
        <div class="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
          <input
            ...
            class="flex-1 px-4 py-3 rounded-lg bg-gray-800 border border-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
          />
          <button
      ...
      <!-- Social Icons -->
      <div v-if="showSocials" class="flex justify-center gap-6 mb-8">
